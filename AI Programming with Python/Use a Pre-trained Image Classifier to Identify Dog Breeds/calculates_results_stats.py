...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        is_label_match = results_dic[key][2]
    ...
    results_stats_dic['n_correct_dog'] = n_correct_dog
    results_stats_dic['n_correct_notdog'] = n_correct_notdog
    results_stats_dic['n_correct_breed'] = n_correct_breed

    results_stats_dic['pct_correct_dogs'] = (n_correct_dog / n_dog_images) * 100
    results_stats_dic['pct_correct_notdogs'] = (n_correct_notdog / n_notdog_images) * 100    
    results_stats_dic['pct_correct_breed'] = (n_correct_breed / n_dog_images) * 100 
